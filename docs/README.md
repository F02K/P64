...
Welcome to the P64 documentation. These pages are written for GitHub readers who
want to try the engine, inspect the editor workflow, or write gameplay scripts.

## Learning Path

1. [Getting Started](getting-started.md) - install P64, open the Hub/editor, run
...
- Sample project: [../samples/FirstScene](../samples/FirstScene)
