...
class Entity:
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if name == "transform" and isinstance(value, Transform):
            value.bind_scene_object(self)

    def __post_init__(self) -> None:
        self._bind_transform_owner_recursive()

    def _bind_transform_owner_recursive(self) -> None:
        self.transform.bind_scene_object(self)
        for child in self.children:
            child.parent = self
            child._bind_transform_owner_recursive()
